  ...
  function createRegistry(projectorApi){
    ...
    function summary(){
      ...
      return {
        ...
        dynamicPolicy:'CAMERA_DYNAMIQUE=KEYFRAMES_VALIDES; SI_AU_MOINS_UNE_KEYFRAME_CONFIANCE_GE_0_5_EXISTE_LES_KEYFRAMES_FAIBLES_SONT_EXCLUES; AGE_MAX_STRICT; INTERPOLATION_UNIQUEMENT_EN_ESPACE_PROJETE; SINON_PROJECTION_INDISPONIBLE'
      };
    }
