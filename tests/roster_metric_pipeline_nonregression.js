...
assert.deepStrictEqual(mixed.heatmap.cells,[[2,0],[0,0]],'only the dominant coherent geometry may contribute to observation-count cells');
assert.deepStrictEqual(mixed.heatmap.timeCells,[[3,0],[0,0]],'only the dominant coherent geometry may contribute to temporal dwell seconds');
