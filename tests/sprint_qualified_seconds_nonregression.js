...
const publishable={...Stats.metricForTrack(track([[0,0],[0.5,3.5],[1.0,7.0],[1.5,10.5],[2.0,14.0],[2.5,17.5],[3.0,21.0],[3.5,24.5]]),projectors),defendableScore:.95,quality:'FIABLE'};
...
assert.strictEqual(published.sprintQualifiedSeconds,3.5);
