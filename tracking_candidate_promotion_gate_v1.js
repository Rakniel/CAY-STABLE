(function(root,factory){
  ...
  function evaluate(baseline,candidate,options){
    const cfg=Object.assign({minSequences:3,minHotaGain:0.5,minIdf1Gain:0,maxMotaDrop:0,maxIdSwitchIncrease:0,maxFalseCayIncrease:0,maxBenchSpectatorIncrease:0},options||{});
    ...
    return {status:promote?'PROMOTE':'REJECT',promote,reason:promote?'CAY_BENCHMARK_GATE_PASSED':'CAY_BENCHMARK_GATE_BLOCKED',delta,blockers,sequenceFloor,thresholds:{...cfg},policy:'TRACKER_CHANGES_REQUIRE_CAY_SEQUENCE_GAINS_WITH_ZERO_TOLERANCE_FOR_FALSE_CAY_BENCH_SPECTATOR_OR_IDENTITY_REGRESSION_BY_DEFAULT'};
  }
  return {evaluate};
});
