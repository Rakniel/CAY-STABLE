...
canonical_tags = [
    ...
    '<script src="./motchallenge_tracking_artifact_adapter_v1.js"></script>',
    ...
    '<script src="./pitch_keypoint_artifact_provider_v1.js"></script>',
    '<script src="./metric_camera_motion_projector_v1.js"></script>',
    '<script src="./camera_motion_artifact_provider_v1.js"></script>',
    ...
    '<script src="./player_card_renderer_v1.js"></script>',
    '<script src="./club_roster_identity_ui_v1.js"></script>',
